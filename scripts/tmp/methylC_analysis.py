...
diff_exp="diff_exp.gff"
no_diff_exp="no_diff_exp.gff"
goi="../../ref/misc/goi.gff"
up="up_diff_exp.gff"
down="down_diff_exp.gff"
filter_chr=['MT','ChrL']
...
if os.path.exists(up):
    print("Gene of interest metaplot")
    functions.feature_metaplot('CDS_allc.tmp',up,genome_file,output="results/up_metaplot.tsv",
                            ignoreStrand=False,windows=60,updown_stream=2000,cutoff=0,
                            filter_features='gene',filter_chr=filter_chr)
else:
    print("No gene annotations found")
...
if os.path.exists(down):
    print("Gene of interest metaplot")
    functions.feature_metaplot('CDS_allc.tmp',down,genome_file,output="results/down_metaplot.tsv",
                            ignoreStrand=False,windows=60,updown_stream=2000,cutoff=0,
                            filter_features='gene',filter_chr=filter_chr)
else:
    print("No gene annotations found")
